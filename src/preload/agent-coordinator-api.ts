...
export function createAgentCoordinatorApi(
  ...
  return {
    ...
    sessions: {
      ...
      renameTerminal: (sessionId, key, title) => invoke(IPC_CHANNELS.sessionsRenameTerminal, sessionId, key, title) as ReturnType<AgentCoordinatorApi["sessions"]["renameTerminal"]>,
