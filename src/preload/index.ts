...
const api: AgentCoordinatorApi = {
  ...
  sessions: {
    ...
    createReviewFromPr: (projectId, input) =>
      ipcRenderer.invoke(IPC_CHANNELS.sessionsCreateReviewFromPr, projectId, input),
    createFixFromPr: (projectId, input) => ipcRenderer.invoke(IPC_CHANNELS.sessionsCreateFixFromPr, projectId, input),
    ...
    claimSetup: (sessionId) => ipcRenderer.invoke(IPC_CHANNELS.sessionsClaimSetup, sessionId),
    releaseSetup: (sessionId) => ipcRenderer.invoke(IPC_CHANNELS.sessionsReleaseSetup, sessionId),
    ...
    buildRoleAutopilot: (sessionId, role, sessionLane, wfPrompt) =>
      ipcRenderer.invoke(IPC_CHANNELS.sessionsBuildRoleAutopilot, sessionId, role, sessionLane, wfPrompt),
    recordRoleAgentSession: (sessionId, role, sessionLane, agentSessionId) =>
      ipcRenderer.invoke(
